...
public final class DebugToolsCoordinator {
    ...
    public void notifyPositionChanged(MagnetView bubble) {
        if (trashView == null) {
            return;
        }
    ...
    private void applyTrashMagnetism(MagnetView bubble) {
    ...
    private boolean isOverTrash(MagnetView bubble) {
    ...
    public void notifyBubbleRelease(MagnetView bubble) {
        if (trashView == null) {
            return;
        }
        if (isOverTrash(bubble)) {
    ...
    public static class Builder {
        ...
        public Builder setTrashView(DebugToolsTrashLayout trashView) {
