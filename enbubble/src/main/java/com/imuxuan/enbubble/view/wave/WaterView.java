package com.imuxuan.enbubble.view.wave;
...
public class WaterView extends View {
    ...
    private int frameColor = Color.parseColor("#dd0000");
...
//        初始化值
        ...
        frameColor = Color.parseColor("#DD0000");
        //圆环渐变的颜色
        color[0] = Color.parseColor("#DD0000");
        color[1] = Color.parseColor("#FF8888");
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        this.h = mHeight;
        canvasPath.addCircle(centerX, centerY, (mHeight + 1) / 2, Path.Direction.CCW);
        reset();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShowFrame) {
            framePaint.setShader(
                    new LinearGradient(mWidth / 2, mHeight, mWidth / 2, 0, color[0], color[1], Shader.TileMode.CLAMP)
            );
            float radius = mHeight / 2 - frameWidth / 2;
