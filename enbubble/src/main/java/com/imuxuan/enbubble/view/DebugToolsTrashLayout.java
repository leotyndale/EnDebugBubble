...
public class DebugToolsTrashLayout extends FrameLayout {
    ...
    public DebugToolsTrashLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DebugToolsTrashLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attachedToWindow) {
            if (visibility != getVisibility()) {
                if (visibility == VISIBLE) {
                    playAnimation(R.animator.debug_tools_trash_shown_animator);


                } else {
                    playAnimation(R.animator.debug_tools_trash_hide_animator);
                }
            }
        }
    ...
    public void applyMagnetism() {
        if (!magnetismApplied) {
            ...
            playAnimation(R.animator.debug_tools_trash_shown_magnetism_animator);
        }
    }
    ...
    public void releaseMagnetism() {
        if (magnetismApplied) {
            ...
            playAnimation(R.animator.debug_tools_trash_hide_magnetism_animator);
        }
